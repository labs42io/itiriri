...
describe('Itiriri (itiriri)', () => {
  describe('When calling entries', () => {
    ...
    it('Should be iterable multiple times', () => {
      const source = [1, 2, 3];
      const q = itiriri(source).entries();
    ...
    it('Should iterate once', () => {
      ...
      itiriri(source).entries().toArray();
  ...
  describe('When calling values', () => {
    ...
    it('Should return a new itiriri with same values', () => {
  ...
  describe('When calling concat', () => {
    ...
    it('Should be iterable multiple times', () => {
      const source = [1, 2, 3];
      const q = itiriri(source).concat(4);
  ...
  describe('When calling prepend', () => {
    ...
    it('Should be iterable multiple times', () => {
      const source = [1, 2, 3];
      const q = itiriri(source).prepend(4);
    ...
    it('Should iterate once', () => {
      const source = new SpyIterable([]);
      itiriri(source).prepend([]).toArray();
  ...
  describe('When calling fill with positive indexes', () => {
    ...
    it('Should be iterable multiple times', () => {
      const source = [1, 2, 3];
      const q = itiriri(source).fill(42);
