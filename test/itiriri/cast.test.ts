...
describe('Itiriri (cast)', () => {
  ...
  describe('When calling toGroups', () => {
    ...
    it('Should return map of 4 groups', () => {
      ...
      const q = itiriri(source).toGroups((_, idx) => idx % 4);
