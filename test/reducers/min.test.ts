...
describe('reducers/min', () => {
  describe('When called on empty array', () => {
    it('Should return undefined', () => {
      ...
      expect(min(source, (a, b) => a - b)).to.be.undefined;
    });
  });
  ...
  describe('When called on some array', () => {
    it('Should return the first element', () => {
      ...
      expect(min(source, (a, b) => a - b)).to.be.equal(-1);
    });

    it('Should return the last element', () => {
      const source = [-10, -2, -11, -13, -664];

      expect(min(source, (a, b) => a - b)).to.be.equal(-664);
    });

    it('Should return the middle element', () => {
      const source = [0.1, 9.9, -10.99, 10.1];

      expect(min(source, (a, b) => a - b)).to.be.equal(-10.99);
    });
  });
});
